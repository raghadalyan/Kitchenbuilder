...
//            SetWindowPos(solidWorksHandle, HWND_TOP, 0, 0, halfWidth, screenHeight, SWP_SHOWWINDOW); // LEFT
//            SetWindowPos(thisHandle, HWND_TOP, halfWidth, 0, halfWidth, screenHeight, SWP_SHOWWINDOW); // RIGHT
